...
def training_loop(
    ...
    while True:
        ...
        if (rank==0) and (connection_grow_kimg is not None) and (connection_grow_step is not None) and (cur_nimg % (connection_grow_step*1000) == 0) and (cur_nimg > -1) and (G_kwargs.connection_grow_from+1<G_kwargs.connection_end):
