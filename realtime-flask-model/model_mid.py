...
# network_pkl = '/home/lhq-blur-41-flasked-006080.pkl'
# classifier_path = {
#     "L0_36_512": {
#         "idx": 0,
...
network_pkl = '/home/ffhq-blur-21-flasked-003204.pkl'
classifier_path = {
    "L0_36_1024": {
        "idx": 0,
        "path": '/home/realtime-flask-model/saved_models/ffhq-blur-28/classifierL0_36_1024_final.pt',
        "bottleneck": 32
    },
    "L1_36_1024": {
        "idx": 1,
        "path": '/home/realtime-flask-model/saved_models/ffhq-blur-28/classifierL1_36_1024_final.pt',
        "bottleneck": 32
    },
    "L2_52_1024": {
        "idx": 2,
        "path": '/home/realtime-flask-model/saved_models/ffhq-blur-28/classifierL2_52_1024_2.pt',
        "bottleneck": 32
    },
    "L3_52_1024": {
        "idx": 3,
        "path": '/home/realtime-flask-model/saved_models/ffhq-blur-28/classifierL3_52_1024_3.pt',
        "bottleneck": 32
    },
    "L4_84_1024": {
        "idx": 4,
        "path": '/home/realtime-flask-model/saved_models/ffhq-blur-28/classifierL4_84_1024_2.pt',
        "bottleneck": 32
    },
    "L5_84_1024": {
        "idx": 5,
        "path": '/home/realtime-flask-model/saved_models/ffhq-blur-28/classifierL5_84_1024_2.pt',
        "bottleneck": 32
    }
}
...
class Pipeline(torch.nn.Module):
   ...
   def initialise_plugins(self):
      #  img = torch.zeros((1,3,self.in_size,self.in_size)).to(self.device)
       img = Image.open('/home/54588.png').resize((256,256)).convert("RGB")
   ...
   def forward(self, img):
       ...
       img_x = self.pre_process.preprocess_to_conditions(img_x)
        
       img = self.g_model(self.z, None, img_x, truncation_psi=0.6, execute_op = True)
       return to_pil_image(img.add(1).div(2).clamp(0, 1)[0].cpu()), to_pil_image(img_x.add(1).div(2).clamp(0, 1)[0].cpu())
